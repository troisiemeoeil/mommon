...
const AboutCard = () => {
  ...
  return (
    <motion.div
      ...
      dragElastic={0}
      className="dark:bg-[#1E1E1E] py-1 bg-white border dark:border-neutral-600 border-neutral-400/60 z-20 cursor-pointer relative shadow-xl rounded-lg col-span-2"
    >
